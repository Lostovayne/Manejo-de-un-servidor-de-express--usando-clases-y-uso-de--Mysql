**Readme para Grupal 6**


*Se creó el archivo queries_grupal para almacenar las queries necesarias para la creacion de las tablas de mysql.*

*Se documentarán todas las funciones correspondientes usando JDOC para su correcto entendimiento y legibilidad*




***Codigo necesario para crear las tablas y la base de datos***
